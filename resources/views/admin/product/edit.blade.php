...
@section('admin.content')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0"><i class="bi bi-pencil-square"></i> Edit New Product</h5>
        </div>
        <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <select class="form-select  select2-categories" name="category_id[]" data-live-search="true"
                                    multiple>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createImagePreviewElement(imageSrc, fileName, input) {
                ...
                removeBtn.onclick = function(e) {
                    ...
                    for (let i = 0; i < input.files.length; i++) {
                        if (input.files[i].name !== fileName) { // Ensure the removed file is skipped
                            dt.items.add(input.files[i]);
                        }
                    }
                    input.files = dt.files; // Update the input with new file list
                };
            ...
            function handleVariantImageUpload(event) {
                ...
                Array.from(files).forEach(file => {
                    const reader = new FileReader();
                    reader.onload = function(e) {
                        const imageDiv = createImagePreviewElement(e.target.result, file.name, input);
                ...
                input.files = dt.files; // Update the input with new files
            }
