...
<div class="page-wrapper">
    <div class="content">
                ...
                <li>
                    <div class="page-btn">
                        <a href="https://dreamspos.dreamstechnologies.com/html/template/product-list.html"
                            class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to
                            Product</a>
                    </div>
                </li>
                <li>
        ...
        <form action="https://dreamspos.dreamstechnologies.com/html/template/edit-product.html">
            <div class="card">
