                            ...
                            @foreach ($stores as $store)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge bg-danger text-white rounded-pill px-3 py-2">Inactive</span>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.store.edit', $store->id) }}" class="btn btn-primary">Edit</a>
                                        <form action="{{ route('admin.store.destroy', $store->id) }}" method="POST" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
