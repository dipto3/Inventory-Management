...
<div class="offcanvas-header border-bottom">
  <h5 class="offcanvas-title" id="cartOffcanvasLabel">
    Your Cart <span class="cart-count">(3)</span>
  </h5>
  <button
    type="button"
    ...
    <div class="cart-item p-3 border-bottom" data-product-id="1">
      <div class="d-flex">
        <div class="cart-item-image me-3">
          <img
            src="http://localhost:63342/e-commerce/images/product.jpeg"
        ...
        <div class="cart-item-details flex-grow-1">
          ...
          <div class="cart-item-variant small text-muted mb-1">
          ...
          <div class="d-flex align-items-center">
            ...
            >
              <button
                class="btn btn-outline-secondary cart-item-quantity-btn"
                type="button"
              ...
              <input
                ...
                class="form-control text-center cart-item-quantity-input"
                value="1"
                readonly
              />
              <button
            ...
            <button
              class="btn btn-sm text-danger ms-auto cart-item-remove"
              data-product-id="1"
            >
...
<div class="offcanvas-footer p-3 border-top bg-light">
  ...
  <div class="cart-actions">
    <a href="cart.html" class="btn btn-outline-primary w-100 mb-2"
      >View Cart</a
    >
    <a href="checkout.html" class="btn btn-primary w-100" id="checkoutBtn"
      >Checkout</a
    >
  </div>
</div>
